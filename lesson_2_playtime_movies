# Prints information about 5 movies in CSV format

movie_titles = ["The Lion King", "Mulan", "Mean Girls", "Serenity", "Star Wars: Episode VI - Return of the Jedi"]
parental_rating = ["G", "G", "PG-13", "PG-13", "PG"]
bechdel_rating = [1, 3, 3, 3, 0]
imdb_rating = [8.5, 7.5, 6.9, 8.0, 8.4]
genre = ["animation / adventure / family", "animation / adventure / family", "comedy", "action / adventure / sci-fi", "action / adventure / fantasy"]
